...
export const projectsData: {
  ...
  },
  {
    ...
    This Web app is basically a travel album where you can keep all your travel memories , photos and other useful informations.
      It features creating or planning a trip, adding and reviewing the trip photo gallery , star rate , globe view of all your visited and created trips, map view , links, paginations, sortings , gallery slider, white and dark theme which is adopted to your browser theme"`,
    techUsed: [
      'React.js',
      'Next.js',
      'TypeScript',
